  ...
  return (
    <div id="contact" className={className}>
      ...
      <div className="mt-24">
        ...
        >
          Got a project in mind? Contact Me! Let&apos;s make something awesome together.
        </motion.p>

        <div className="mx-auto mt-20 grid w-fit grid-cols-1 justify-items-center gap-10 text-base leading-7 sm:grid-cols-2 sm:gap-x-14 lg:grid-cols-3 lg:gap-x-16">
          {socialNetwork.map((item, i) => (
            <motion.a
              ...
              href={item.path}
              className={clsx(
                "min-w-[15rem] w-fit max-w-full",
                i === socialNetwork.length - 1 && "lg:col-start-2",
              )}
            >
